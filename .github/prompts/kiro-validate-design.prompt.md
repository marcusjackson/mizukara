...
2. **Read Review Guidelines**:
   ...
   - Read `.github/instructions/spec-writing.instructions.md` for spec standards
   - Read `.kiro/steering/specs.md` for living documentation philosophy

3. **Execute Design Review**:
   - Follow design-review.md process: Analysis → Critical Issues → Strengths → GO/NO-GO
   - **Check for implementation details** (CRITICAL):
     - Scan design files for SQL queries, algorithm pseudocode, step-by-step procedures
     - Flag as critical issue if found (these belong in code, not specs)
     - Suggest contract-focused replacements with file references
