...
- Consider running `/kiro-spec-finalize <feature>` to review and clean up any implementation details in specs
- Specs transition to living documentation for maintenance
...
**Note**: Validation is recommended after implementation to ensure spec alignment and quality. Consider finalizing specs as living documentation with `/kiro-spec-finalize`.
