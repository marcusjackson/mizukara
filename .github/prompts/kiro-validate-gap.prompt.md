...
4. **Generate Analysis Document**:
   - Create comprehensive gap analysis at `.kiro/specs/$1/_reference/gap-analysis.md`
   - Ensure `_reference/` directory exists (create if needed)
   - Follow the output guidelines in `.kiro/settings/rules/gap-analysis.md`
...
2. **Document Status**: Confirm gap analysis generated at `.kiro/specs/$1/_reference/gap-analysis.md` (point-in-time reference, not maintained)
