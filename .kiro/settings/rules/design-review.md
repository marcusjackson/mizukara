...
### 5. Living Documentation Compliance

- Specs focus on "WHAT" and "WHY", not "HOW"
- No implementation details (SQL queries, algorithms, pseudocode, step-by-step procedures)
- References to implementation files instead of code duplication
- Clear contracts and business rules without prescribing implementation
- Suitable as living documentation throughout project lifecycle

## Review Process

### Step 1: Analyze

Analyze design against all review criteria, focusing on critical issues impacting integration, maintainability, complexity, requirements fulfillment, and living documentation compliance.

### Step 2: Identify Critical Issues (≤3)

Common critical issues include:

- Architectural misalignment with existing system
- Type safety violations or unsafe patterns
- Requirements coverage gaps
- **Implementation details in specs** (SQL, algorithms, pseudocode)
- Excessive complexity or unclear boundaries
...
Before GO decision, verify design is free of implementation details:

- [ ] No detailed SQL queries or database implementation code
- [ ] No algorithm pseudocode or step-by-step procedures
- [ ] No line-by-line implementation instructions
- [ ] No TypeScript function bodies or specific code structure
- [ ] Describes contracts (inputs/outputs/errors), not implementation
- [ ] References implementation files instead of duplicating code
- [ ] Suitable as living documentation post-implementation

**If implementation details found**: Extract to `research.md` or replace with contract descriptions before GO.
...
- **Implementation Details**: Removed or flagged for removal
